...
part 'organisation_invitation_update.g.dart';
...
/// * [status] 
/// * [organisation] 
abstract class OrganisationInvitationUpdate implements Built<OrganisationInvitationUpdate, OrganisationInvitationUpdateBuilder> {
    ...
    OrganisationInvitationUpdate._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(OrganisationInvitationUpdateBuilder b) => b;

    factory OrganisationInvitationUpdate([void updates(OrganisationInvitationUpdateBuilder b)]) = _$OrganisationInvitationUpdate;

    @BuiltValueSerializer(custom: true)
    static Serializer<OrganisationInvitationUpdate> get serializer => _$OrganisationInvitationUpdateSerializer();
}

class _$OrganisationInvitationUpdateSerializer implements StructuredSerializer<OrganisationInvitationUpdate> {
    @override
    final Iterable<Type> types = const [OrganisationInvitationUpdate, _$OrganisationInvitationUpdate];

    @override
    final String wireName = r'OrganisationInvitationUpdate';

    @override
    Iterable<Object?> serialize(Serializers serializers, OrganisationInvitationUpdate object,
    ...
    @override
    OrganisationInvitationUpdate deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = OrganisationInvitationUpdateBuilder();
