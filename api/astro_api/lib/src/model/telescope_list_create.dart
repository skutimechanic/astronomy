...
part 'telescope_list_create.g.dart';
...
/// * [isRelocatable] 
/// * [images] 
abstract class TelescopeListCreate implements Built<TelescopeListCreate, TelescopeListCreateBuilder> {
    ...
    TelescopeListCreate._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(TelescopeListCreateBuilder b) => b;

    factory TelescopeListCreate([void updates(TelescopeListCreateBuilder b)]) = _$TelescopeListCreate;

    @BuiltValueSerializer(custom: true)
    static Serializer<TelescopeListCreate> get serializer => _$TelescopeListCreateSerializer();
}

class _$TelescopeListCreateSerializer implements StructuredSerializer<TelescopeListCreate> {
    @override
    final Iterable<Type> types = const [TelescopeListCreate, _$TelescopeListCreate];

    @override
    final String wireName = r'TelescopeListCreate';

    @override
    Iterable<Object?> serialize(Serializers serializers, TelescopeListCreate object,
    ...
    @override
    TelescopeListCreate deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TelescopeListCreateBuilder();
