...
import 'package:astro_api/src/model/observing_site_images_list.dart';
import 'package:astro_api/src/model/address.dart';
import 'package:built_collection/built_collection.dart';
import 'package:astro_api/src/model/coordinates.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'patched_observing_site_list_create.g.dart';
...
/// * [telescopes] 
/// * [images] 
abstract class PatchedObservingSiteListCreate implements Built<PatchedObservingSiteListCreate, PatchedObservingSiteListCreateBuilder> {
    ...
    PatchedObservingSiteListCreate._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(PatchedObservingSiteListCreateBuilder b) => b;

    factory PatchedObservingSiteListCreate([void updates(PatchedObservingSiteListCreateBuilder b)]) = _$PatchedObservingSiteListCreate;

    @BuiltValueSerializer(custom: true)
    static Serializer<PatchedObservingSiteListCreate> get serializer => _$PatchedObservingSiteListCreateSerializer();
}

class _$PatchedObservingSiteListCreateSerializer implements StructuredSerializer<PatchedObservingSiteListCreate> {
    @override
    final Iterable<Type> types = const [PatchedObservingSiteListCreate, _$PatchedObservingSiteListCreate];

    @override
    final String wireName = r'PatchedObservingSiteListCreate';

    @override
    Iterable<Object?> serialize(Serializers serializers, PatchedObservingSiteListCreate object,
    ...
    @override
    PatchedObservingSiteListCreate deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PatchedObservingSiteListCreateBuilder();
