...
part 'observing_site_list_create.g.dart';
...
/// * [telescopes] 
/// * [images] 
abstract class ObservingSiteListCreate implements Built<ObservingSiteListCreate, ObservingSiteListCreateBuilder> {
    ...
    ObservingSiteListCreate._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(ObservingSiteListCreateBuilder b) => b;

    factory ObservingSiteListCreate([void updates(ObservingSiteListCreateBuilder b)]) = _$ObservingSiteListCreate;

    @BuiltValueSerializer(custom: true)
    static Serializer<ObservingSiteListCreate> get serializer => _$ObservingSiteListCreateSerializer();
}

class _$ObservingSiteListCreateSerializer implements StructuredSerializer<ObservingSiteListCreate> {
    @override
    final Iterable<Type> types = const [ObservingSiteListCreate, _$ObservingSiteListCreate];

    @override
    final String wireName = r'ObservingSiteListCreate';

    @override
    Iterable<Object?> serialize(Serializers serializers, ObservingSiteListCreate object,
    ...
    @override
    ObservingSiteListCreate deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = ObservingSiteListCreateBuilder();
