...
part of 'organisation_list.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$OrganisationList extends OrganisationList {
  @override
  final int pk;
  @override
  final String? name;
  ...
  factory _$OrganisationList(
          [void Function(OrganisationListBuilder)? updates]) =>
      (new OrganisationListBuilder()..update(updates))._build();

  _$OrganisationList._(
      {required this.pk,
      this.name,
      this.instituteName1,
      this.instituteName2,
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(pk, r'OrganisationList', 'pk');
    BuiltValueNullFieldError.checkNotNull(
        dateCreated, r'OrganisationList', 'dateCreated');
    BuiltValueNullFieldError.checkNotNull(
        telescopeActivations, r'OrganisationList', 'telescopeActivations');
  }

  @override
  OrganisationList rebuild(void Function(OrganisationListBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  OrganisationListBuilder toBuilder() =>
      new OrganisationListBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is OrganisationList &&
        pk == other.pk &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OrganisationList')
          ..add('pk', pk)
          ..add('name', name)
...
class OrganisationListBuilder
    implements Builder<OrganisationList, OrganisationListBuilder> {
  _$OrganisationList? _$v;
  ...
  OrganisationListBuilder() {
    OrganisationList._defaults(this);
  }

  OrganisationListBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _pk = $v.pk;
      _name = $v.name;
  ...
  @override
  void replace(OrganisationList other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$OrganisationList;
  }

  @override
  void update(void Function(OrganisationListBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  OrganisationList build() => _build();

  _$OrganisationList _build() {
    _$OrganisationList _$result;
    try {
      _$result = _$v ??
          new _$OrganisationList._(
              pk: BuiltValueNullFieldError.checkNotNull(
                  pk, r'OrganisationList', 'pk'),
              name: name,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'OrganisationList', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
