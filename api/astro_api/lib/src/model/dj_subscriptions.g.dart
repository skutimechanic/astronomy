...
part of 'dj_subscriptions.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DJSubscriptions extends DJSubscriptions {
  @override
  ...
  factory _$DJSubscriptions([void Function(DJSubscriptionsBuilder)? updates]) =>
      (new DJSubscriptionsBuilder()..update(updates))._build();
  ...
  _$DJSubscriptions._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        djstripeId, r'DJSubscriptions', 'djstripeId');
    BuiltValueNullFieldError.checkNotNull(plan, r'DJSubscriptions', 'plan');
    BuiltValueNullFieldError.checkNotNull(price, r'DJSubscriptions', 'price');
    BuiltValueNullFieldError.checkNotNull(
        canReactivate, r'DJSubscriptions', 'canReactivate');
    BuiltValueNullFieldError.checkNotNull(
        djstripeCreated, r'DJSubscriptions', 'djstripeCreated');
    BuiltValueNullFieldError.checkNotNull(
        djstripeUpdated, r'DJSubscriptions', 'djstripeUpdated');
    BuiltValueNullFieldError.checkNotNull(id, r'DJSubscriptions', 'id');
    BuiltValueNullFieldError.checkNotNull(
        currentPeriodEnd, r'DJSubscriptions', 'currentPeriodEnd');
    BuiltValueNullFieldError.checkNotNull(
        currentPeriodStart, r'DJSubscriptions', 'currentPeriodStart');
    BuiltValueNullFieldError.checkNotNull(
        customer, r'DJSubscriptions', 'customer');
  }

  @override
  DJSubscriptions rebuild(void Function(DJSubscriptionsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DJSubscriptionsBuilder toBuilder() =>
      new DJSubscriptionsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DJSubscriptions &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DJSubscriptions')
...
class DJSubscriptionsBuilder
    implements Builder<DJSubscriptions, DJSubscriptionsBuilder> {
  _$DJSubscriptions? _$v;
  ...
  DJSubscriptionsBuilder() {
    DJSubscriptions._defaults(this);
  }

  DJSubscriptionsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(DJSubscriptions other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$DJSubscriptions;
  }

  @override
  void update(void Function(DJSubscriptionsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DJSubscriptions build() => _build();

  _$DJSubscriptions _build() {
    _$DJSubscriptions _$result;
    try {
      _$result = _$v ??
          new _$DJSubscriptions._(
              djstripeId: BuiltValueNullFieldError.checkNotNull(
                  djstripeId, r'DJSubscriptions', 'djstripeId'),
              plan: plan.build(),
              price: price.build(),
              canReactivate: BuiltValueNullFieldError.checkNotNull(
                  canReactivate, r'DJSubscriptions', 'canReactivate'),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'DJSubscriptions', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
