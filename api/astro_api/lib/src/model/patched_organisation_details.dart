...
part 'patched_organisation_details.g.dart';
...
abstract class PatchedOrganisationDetails implements Built<PatchedOrganisationDetails, PatchedOrganisationDetailsBuilder> {
    ...
    PatchedOrganisationDetails._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(PatchedOrganisationDetailsBuilder b) => b;

    factory PatchedOrganisationDetails([void updates(PatchedOrganisationDetailsBuilder b)]) = _$PatchedOrganisationDetails;

    @BuiltValueSerializer(custom: true)
    static Serializer<PatchedOrganisationDetails> get serializer => _$PatchedOrganisationDetailsSerializer();
}

class _$PatchedOrganisationDetailsSerializer implements StructuredSerializer<PatchedOrganisationDetails> {
    @override
    final Iterable<Type> types = const [PatchedOrganisationDetails, _$PatchedOrganisationDetails];

    @override
    final String wireName = r'PatchedOrganisationDetails';

    @override
    Iterable<Object?> serialize(Serializers serializers, PatchedOrganisationDetails object,
        ...
        if (object.telescopeActivations != null) {
            result
    ...
    @override
    PatchedOrganisationDetails deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PatchedOrganisationDetailsBuilder();
