...
part of 'dj_subscription_price.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DJSubscriptionPrice extends DJSubscriptionPrice {
  @override
  ...
  factory _$DJSubscriptionPrice(
          [void Function(DJSubscriptionPriceBuilder)? updates]) =>
      (new DJSubscriptionPriceBuilder()..update(updates))._build();

  _$DJSubscriptionPrice._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        djstripeId, r'DJSubscriptionPrice', 'djstripeId');
    BuiltValueNullFieldError.checkNotNull(
        djstripeCreated, r'DJSubscriptionPrice', 'djstripeCreated');
    BuiltValueNullFieldError.checkNotNull(
        djstripeUpdated, r'DJSubscriptionPrice', 'djstripeUpdated');
    BuiltValueNullFieldError.checkNotNull(id, r'DJSubscriptionPrice', 'id');
    BuiltValueNullFieldError.checkNotNull(
        active, r'DJSubscriptionPrice', 'active');
    BuiltValueNullFieldError.checkNotNull(
        currency, r'DJSubscriptionPrice', 'currency');
    BuiltValueNullFieldError.checkNotNull(
        product, r'DJSubscriptionPrice', 'product');
  }

  @override
  DJSubscriptionPrice rebuild(
          void Function(DJSubscriptionPriceBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DJSubscriptionPriceBuilder toBuilder() =>
      new DJSubscriptionPriceBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DJSubscriptionPrice &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DJSubscriptionPrice')
...
class DJSubscriptionPriceBuilder
    implements Builder<DJSubscriptionPrice, DJSubscriptionPriceBuilder> {
  _$DJSubscriptionPrice? _$v;
  ...
  DJSubscriptionPriceBuilder() {
    DJSubscriptionPrice._defaults(this);
  }

  DJSubscriptionPriceBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(DJSubscriptionPrice other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$DJSubscriptionPrice;
  }

  @override
  void update(void Function(DJSubscriptionPriceBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DJSubscriptionPrice build() => _build();

  _$DJSubscriptionPrice _build() {
    _$DJSubscriptionPrice _$result;
    try {
      _$result = _$v ??
          new _$DJSubscriptionPrice._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'DJSubscriptionPrice', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
