...
import 'package:astro_api/src/model/paginated_publication_list.dart';
import 'package:astro_api/src/model/publication_full.dart';
...
class PublicationsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PaginatedPublicationList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PaginatedPublicationList>> publicationsFormattedList({ 
    ...
    final _path = r'/publications{format}'.replaceAll('{' r'format' '}', format.toString());
    ...
    PaginatedPublicationList _responseData;

    try {
      const _responseType = FullType(PaginatedPublicationList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as PaginatedPublicationList;
    ...
    return Response<PaginatedPublicationList>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [PaginatedPublicationList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PaginatedPublicationList>> publicationsList({ 
    int? page,
    int? pageSize,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PublicationFull] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PublicationFull>> publicationsRetrieve({ 
    ...
    final _path = r'/publications/{bibcode}/'.replaceAll('{' r'bibcode' '}', bibcode.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PublicationFull _responseData;

    try {
      const _responseType = FullType(PublicationFull);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as PublicationFull;
    ...
    return Response<PublicationFull>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
