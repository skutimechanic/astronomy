...
abstract class OrganisationList implements Built<OrganisationList, OrganisationListBuilder> {
    ...
    static void _defaults(OrganisationListBuilder b) => b;

    factory OrganisationList([void updates(OrganisationListBuilder b)]) = _$OrganisationList;

    @BuiltValueSerializer(custom: true)
    static Serializer<OrganisationList> get serializer => _$OrganisationListSerializer();
}

class _$OrganisationListSerializer implements StructuredSerializer<OrganisationList> {
    @override
    final Iterable<Type> types = const [OrganisationList, _$OrganisationList];

    @override
    final String wireName = r'OrganisationList';

    @override
    Iterable<Object?> serialize(Serializers serializers, OrganisationList object,
    ...
    @override
    OrganisationList deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = OrganisationListBuilder();
