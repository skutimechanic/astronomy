...
part of 'patched_activity_subscription_update.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PatchedActivitySubscriptionUpdate
    extends PatchedActivitySubscriptionUpdate {
  @override
  final int? pk;
  @override
  final String? owner;
  ...
  factory _$PatchedActivitySubscriptionUpdate(
          [void Function(PatchedActivitySubscriptionUpdateBuilder)? updates]) =>
      (new PatchedActivitySubscriptionUpdateBuilder()..update(updates))
          ._build();

  _$PatchedActivitySubscriptionUpdate._(
      {this.pk,
      this.owner,
      this.isActive,
      this.dateCreated,
  ...
  @override
  PatchedActivitySubscriptionUpdate rebuild(
          void Function(PatchedActivitySubscriptionUpdateBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PatchedActivitySubscriptionUpdateBuilder toBuilder() =>
      new PatchedActivitySubscriptionUpdateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PatchedActivitySubscriptionUpdate &&
        pk == other.pk &&
        owner == other.owner &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PatchedActivitySubscriptionUpdate')
          ..add('pk', pk)
          ..add('owner', owner)
...
class PatchedActivitySubscriptionUpdateBuilder
    implements
        Builder<PatchedActivitySubscriptionUpdate,
            PatchedActivitySubscriptionUpdateBuilder> {
  _$PatchedActivitySubscriptionUpdate? _$v;
  ...
  PatchedActivitySubscriptionUpdateBuilder() {
    PatchedActivitySubscriptionUpdate._defaults(this);
  }

  PatchedActivitySubscriptionUpdateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _pk = $v.pk;
      _owner = $v.owner;
  ...
  @override
  void replace(PatchedActivitySubscriptionUpdate other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PatchedActivitySubscriptionUpdate;
  }
  ...
  @override
  PatchedActivitySubscriptionUpdate build() => _build();

  _$PatchedActivitySubscriptionUpdate _build() {
    _$PatchedActivitySubscriptionUpdate _$result;
    try {
      _$result = _$v ??
          new _$PatchedActivitySubscriptionUpdate._(
              pk: pk,
              owner: owner,
              isActive: isActive,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PatchedActivitySubscriptionUpdate', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
