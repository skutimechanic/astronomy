...
part of 'telescope_list_create.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$TelescopeListCreate extends TelescopeListCreate {
  @override
  final String uuid;
  @override
  final String name;
  ...
  factory _$TelescopeListCreate(
          [void Function(TelescopeListCreateBuilder)? updates]) =>
      (new TelescopeListCreateBuilder()..update(updates))._build();

  _$TelescopeListCreate._(
      {required this.uuid,
      required this.name,
      this.acronym,
      this.alias,
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(uuid, r'TelescopeListCreate', 'uuid');
    BuiltValueNullFieldError.checkNotNull(name, r'TelescopeListCreate', 'name');
    BuiltValueNullFieldError.checkNotNull(
        observingSite, r'TelescopeListCreate', 'observingSite');
    BuiltValueNullFieldError.checkNotNull(
        instruments, r'TelescopeListCreate', 'instruments');
    BuiltValueNullFieldError.checkNotNull(
        images, r'TelescopeListCreate', 'images');
  }

  @override
  TelescopeListCreate rebuild(
          void Function(TelescopeListCreateBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  TelescopeListCreateBuilder toBuilder() =>
      new TelescopeListCreateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TelescopeListCreate &&
        uuid == other.uuid &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'TelescopeListCreate')
          ..add('uuid', uuid)
          ..add('name', name)
          ..add('acronym', acronym)
          ..add('alias', alias)
...
class TelescopeListCreateBuilder
    implements Builder<TelescopeListCreate, TelescopeListCreateBuilder> {
  _$TelescopeListCreate? _$v;
  ...
  TelescopeListCreateBuilder() {
    TelescopeListCreate._defaults(this);
  }

  TelescopeListCreateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _uuid = $v.uuid;
      _name = $v.name;
  ...
  @override
  void replace(TelescopeListCreate other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$TelescopeListCreate;
  }

  @override
  void update(void Function(TelescopeListCreateBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  TelescopeListCreate build() => _build();

  _$TelescopeListCreate _build() {
    _$TelescopeListCreate _$result;
    try {
      _$result = _$v ??
          new _$TelescopeListCreate._(
              uuid: BuiltValueNullFieldError.checkNotNull(
                  uuid, r'TelescopeListCreate', 'uuid'),
              name: BuiltValueNullFieldError.checkNotNull(
                  name, r'TelescopeListCreate', 'name'),
              acronym: acronym,
              alias: alias,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'TelescopeListCreate', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
