...
/// * [isRelocatable] 
/// * [images] 
abstract class TelescopeUpdate implements Built<TelescopeUpdate, TelescopeUpdateBuilder> {
    ...
    static void _defaults(TelescopeUpdateBuilder b) => b;

    factory TelescopeUpdate([void updates(TelescopeUpdateBuilder b)]) = _$TelescopeUpdate;

    @BuiltValueSerializer(custom: true)
    static Serializer<TelescopeUpdate> get serializer => _$TelescopeUpdateSerializer();
}

class _$TelescopeUpdateSerializer implements StructuredSerializer<TelescopeUpdate> {
    @override
    final Iterable<Type> types = const [TelescopeUpdate, _$TelescopeUpdate];

    @override
    final String wireName = r'TelescopeUpdate';

    @override
    Iterable<Object?> serialize(Serializers serializers, TelescopeUpdate object,
    ...
    @override
    TelescopeUpdate deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TelescopeUpdateBuilder();
