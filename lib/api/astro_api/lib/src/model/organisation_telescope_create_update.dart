...
part 'organisation_telescope_create_update.g.dart';
...
/// * [images] 
/// * [ownershipMode] 
abstract class OrganisationTelescopeCreateUpdate implements Built<OrganisationTelescopeCreateUpdate, OrganisationTelescopeCreateUpdateBuilder> {
    ...
    OrganisationTelescopeCreateUpdate._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(OrganisationTelescopeCreateUpdateBuilder b) => b;

    factory OrganisationTelescopeCreateUpdate([void updates(OrganisationTelescopeCreateUpdateBuilder b)]) = _$OrganisationTelescopeCreateUpdate;

    @BuiltValueSerializer(custom: true)
    static Serializer<OrganisationTelescopeCreateUpdate> get serializer => _$OrganisationTelescopeCreateUpdateSerializer();
}

class _$OrganisationTelescopeCreateUpdateSerializer implements StructuredSerializer<OrganisationTelescopeCreateUpdate> {
    @override
    final Iterable<Type> types = const [OrganisationTelescopeCreateUpdate, _$OrganisationTelescopeCreateUpdate];

    @override
    final String wireName = r'OrganisationTelescopeCreateUpdate';

    @override
    Iterable<Object?> serialize(Serializers serializers, OrganisationTelescopeCreateUpdate object,
        ...
        result
            ...
            ..add(object.ownershipMode == null ? null : serializers.serialize(object.ownershipMode,
                specifiedType: const FullType.nullable(String)));
        return result;
    }

    @override
    OrganisationTelescopeCreateUpdate deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = OrganisationTelescopeCreateUpdateBuilder();
