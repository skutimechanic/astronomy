...
import 'package:astro_api/src/model/interval_enum.dart';
import 'package:astro_api/src/model/usage_type_enum.dart';
import 'package:astro_api/src/model/dj_subscription_plan_billing_scheme.dart';
import 'package:astro_api/src/model/dj_subscription_plan_aggregate_usage.dart';
import 'package:astro_api/src/model/dj_subscription_plan_tiers_mode.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'dj_subscription_plan.g.dart';
...
abstract class DJSubscriptionPlan implements Built<DJSubscriptionPlan, DJSubscriptionPlanBuilder> {
    ...
    DJSubscriptionPlan._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(DJSubscriptionPlanBuilder b) => b;

    factory DJSubscriptionPlan([void updates(DJSubscriptionPlanBuilder b)]) = _$DJSubscriptionPlan;

    @BuiltValueSerializer(custom: true)
    static Serializer<DJSubscriptionPlan> get serializer => _$DJSubscriptionPlanSerializer();
}

class _$DJSubscriptionPlanSerializer implements StructuredSerializer<DJSubscriptionPlan> {
    @override
    final Iterable<Type> types = const [DJSubscriptionPlan, _$DJSubscriptionPlan];

    @override
    final String wireName = r'DJSubscriptionPlan';

    @override
    Iterable<Object?> serialize(Serializers serializers, DJSubscriptionPlan object,
    ...
    @override
    DJSubscriptionPlan deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = DJSubscriptionPlanBuilder();
