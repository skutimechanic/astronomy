...
part of 'patched_data_package.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PatchedDataPackage extends PatchedDataPackage {
  @override
  final String? uuid;
  @override
  ...
  factory _$PatchedDataPackage(
          [void Function(PatchedDataPackageBuilder)? updates]) =>
      (new PatchedDataPackageBuilder()..update(updates))._build();

  _$PatchedDataPackage._(
      {this.uuid,
      this.profile,
      this.datasets,
      this.name,
  ...
  @override
  PatchedDataPackage rebuild(
          void Function(PatchedDataPackageBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PatchedDataPackageBuilder toBuilder() =>
      new PatchedDataPackageBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PatchedDataPackage &&
        uuid == other.uuid &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PatchedDataPackage')
          ..add('uuid', uuid)
          ..add('profile', profile)
...
class PatchedDataPackageBuilder
    implements Builder<PatchedDataPackage, PatchedDataPackageBuilder> {
  _$PatchedDataPackage? _$v;
  ...
  PatchedDataPackageBuilder() {
    PatchedDataPackage._defaults(this);
  }

  PatchedDataPackageBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _uuid = $v.uuid;
      _profile = $v.profile;
  ...
  @override
  void replace(PatchedDataPackage other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PatchedDataPackage;
  }

  @override
  void update(void Function(PatchedDataPackageBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PatchedDataPackage build() => _build();

  _$PatchedDataPackage _build() {
    _$PatchedDataPackage _$result;
    try {
      _$result = _$v ??
          new _$PatchedDataPackage._(
              uuid: uuid,
              profile: profile,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PatchedDataPackage', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
