...
/// * [errorMin] 
/// * [bibcode] 
abstract class Gravity implements Built<Gravity, GravityBuilder> {
    ...
    static void _defaults(GravityBuilder b) => b;

    factory Gravity([void updates(GravityBuilder b)]) = _$Gravity;

    @BuiltValueSerializer(custom: true)
    static Serializer<Gravity> get serializer => _$GravitySerializer();
}

class _$GravitySerializer implements StructuredSerializer<Gravity> {
    @override
    final Iterable<Type> types = const [Gravity, _$Gravity];

    @override
    final String wireName = r'Gravity';

    @override
    Iterable<Object?> serialize(Serializers serializers, Gravity object,
    ...
    @override
    Gravity deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = GravityBuilder();
