...
import 'package:astro_api/src/model/telescope_image_list.dart';
import 'package:astro_api/src/model/coordinates.dart';
import 'package:astro_api/src/model/horizon_mask.dart';
import 'package:astro_api/src/model/mirror.dart';
import 'package:astro_api/src/model/dome.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'telescope_update_list_telescope.g.dart';

/// TelescopeUpdateListTelescope
///
/// Properties:
/// * [uuid] 
/// * [name] 
...
/// * [isRelocatable] 
/// * [images] 
abstract class TelescopeUpdateListTelescope implements Built<TelescopeUpdateListTelescope, TelescopeUpdateListTelescopeBuilder> {
    ...
    TelescopeUpdateListTelescope._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(TelescopeUpdateListTelescopeBuilder b) => b;

    factory TelescopeUpdateListTelescope([void updates(TelescopeUpdateListTelescopeBuilder b)]) = _$TelescopeUpdateListTelescope;

    @BuiltValueSerializer(custom: true)
    static Serializer<TelescopeUpdateListTelescope> get serializer => _$TelescopeUpdateListTelescopeSerializer();
}

class _$TelescopeUpdateListTelescopeSerializer implements StructuredSerializer<TelescopeUpdateListTelescope> {
    @override
    final Iterable<Type> types = const [TelescopeUpdateListTelescope, _$TelescopeUpdateListTelescope];

    @override
    final String wireName = r'TelescopeUpdateListTelescope';

    @override
    Iterable<Object?> serialize(Serializers serializers, TelescopeUpdateListTelescope object,
    ...
    @override
    TelescopeUpdateListTelescope deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TelescopeUpdateListTelescopeBuilder();
