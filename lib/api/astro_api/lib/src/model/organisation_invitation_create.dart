...
part 'organisation_invitation_create.g.dart';
...
/// * [status] 
/// * [organisation] 
abstract class OrganisationInvitationCreate implements Built<OrganisationInvitationCreate, OrganisationInvitationCreateBuilder> {
    ...
    OrganisationInvitationCreate._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(OrganisationInvitationCreateBuilder b) => b;

    factory OrganisationInvitationCreate([void updates(OrganisationInvitationCreateBuilder b)]) = _$OrganisationInvitationCreate;

    @BuiltValueSerializer(custom: true)
    static Serializer<OrganisationInvitationCreate> get serializer => _$OrganisationInvitationCreateSerializer();
}

class _$OrganisationInvitationCreateSerializer implements StructuredSerializer<OrganisationInvitationCreate> {
    @override
    final Iterable<Type> types = const [OrganisationInvitationCreate, _$OrganisationInvitationCreate];

    @override
    final String wireName = r'OrganisationInvitationCreate';

    @override
    Iterable<Object?> serialize(Serializers serializers, OrganisationInvitationCreate object,
    ...
    @override
    OrganisationInvitationCreate deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = OrganisationInvitationCreateBuilder();
