...
import 'package:astro_api/src/model/org_type_enum.dart';
...
part 'membership_list_organisation.g.dart';

/// MembershipListOrganisation
///
/// Properties:
/// * [pk] 
/// * [name] 
...
abstract class MembershipListOrganisation implements Built<MembershipListOrganisation, MembershipListOrganisationBuilder> {
    ...
    MembershipListOrganisation._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(MembershipListOrganisationBuilder b) => b;

    factory MembershipListOrganisation([void updates(MembershipListOrganisationBuilder b)]) = _$MembershipListOrganisation;

    @BuiltValueSerializer(custom: true)
    static Serializer<MembershipListOrganisation> get serializer => _$MembershipListOrganisationSerializer();
}

class _$MembershipListOrganisationSerializer implements StructuredSerializer<MembershipListOrganisation> {
    @override
    final Iterable<Type> types = const [MembershipListOrganisation, _$MembershipListOrganisation];

    @override
    final String wireName = r'MembershipListOrganisation';

    @override
    Iterable<Object?> serialize(Serializers serializers, MembershipListOrganisation object,
    ...
    @override
    MembershipListOrganisation deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = MembershipListOrganisationBuilder();
