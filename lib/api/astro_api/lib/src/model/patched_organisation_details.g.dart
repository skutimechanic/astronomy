...
part of 'patched_organisation_details.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PatchedOrganisationDetails extends PatchedOrganisationDetails {
  @override
  final int? pk;
  @override
  final String? name;
  ...
  factory _$PatchedOrganisationDetails(
          [void Function(PatchedOrganisationDetailsBuilder)? updates]) =>
      (new PatchedOrganisationDetailsBuilder()..update(updates))._build();

  _$PatchedOrganisationDetails._(
      {this.pk,
      this.name,
      this.instituteName1,
      this.instituteName2,
      ...
      this.observingSites,
      this.telescopes,
      this.telescopeActivations})
      : super._();

  @override
  PatchedOrganisationDetails rebuild(
          void Function(PatchedOrganisationDetailsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PatchedOrganisationDetailsBuilder toBuilder() =>
      new PatchedOrganisationDetailsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PatchedOrganisationDetails &&
        pk == other.pk &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PatchedOrganisationDetails')
          ..add('pk', pk)
          ..add('name', name)
...
class PatchedOrganisationDetailsBuilder
    implements
        Builder<PatchedOrganisationDetails, PatchedOrganisationDetailsBuilder> {
  _$PatchedOrganisationDetails? _$v;
  ...
  PatchedOrganisationDetailsBuilder() {
    PatchedOrganisationDetails._defaults(this);
  }

  PatchedOrganisationDetailsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _pk = $v.pk;
      _name = $v.name;
  ...
  @override
  void replace(PatchedOrganisationDetails other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PatchedOrganisationDetails;
  }

  @override
  void update(void Function(PatchedOrganisationDetailsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PatchedOrganisationDetails build() => _build();

  _$PatchedOrganisationDetails _build() {
    _$PatchedOrganisationDetails _$result;
    try {
      _$result = _$v ??
          new _$PatchedOrganisationDetails._(
              pk: pk,
              name: name,
              ...
              telescopeActivations: _telescopeActivations?.build());
    } catch (_) {
      ...
      try {
        ...
        _telescopeActivations?.build();
      } catch (e) {
        throw new BuiltValueNestedFieldError(
            r'PatchedOrganisationDetails', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
