...
part of 'activity_subscription_create.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ActivitySubscriptionCreate extends ActivitySubscriptionCreate {
  @override
  final int pk;
  @override
  final String? owner;
  ...
  factory _$ActivitySubscriptionCreate(
          [void Function(ActivitySubscriptionCreateBuilder)? updates]) =>
      (new ActivitySubscriptionCreateBuilder()..update(updates))._build();

  _$ActivitySubscriptionCreate._(
      {required this.pk,
      this.owner,
    ...
    BuiltValueNullFieldError.checkNotNull(
        pk, r'ActivitySubscriptionCreate', 'pk');
    BuiltValueNullFieldError.checkNotNull(
        isActive, r'ActivitySubscriptionCreate', 'isActive');
    BuiltValueNullFieldError.checkNotNull(
        dateCreated, r'ActivitySubscriptionCreate', 'dateCreated');
    BuiltValueNullFieldError.checkNotNull(
        emailsSent, r'ActivitySubscriptionCreate', 'emailsSent');
  }

  @override
  ActivitySubscriptionCreate rebuild(
          void Function(ActivitySubscriptionCreateBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ActivitySubscriptionCreateBuilder toBuilder() =>
      new ActivitySubscriptionCreateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ActivitySubscriptionCreate &&
        pk == other.pk &&
        owner == other.owner &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ActivitySubscriptionCreate')
          ..add('pk', pk)
          ..add('owner', owner)
...
class ActivitySubscriptionCreateBuilder
    implements
        Builder<ActivitySubscriptionCreate, ActivitySubscriptionCreateBuilder> {
  _$ActivitySubscriptionCreate? _$v;
  ...
  ActivitySubscriptionCreateBuilder() {
    ActivitySubscriptionCreate._defaults(this);
  }

  ActivitySubscriptionCreateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _pk = $v.pk;
      _owner = $v.owner;
  ...
  @override
  void replace(ActivitySubscriptionCreate other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ActivitySubscriptionCreate;
  }

  @override
  void update(void Function(ActivitySubscriptionCreateBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ActivitySubscriptionCreate build() => _build();

  _$ActivitySubscriptionCreate _build() {
    _$ActivitySubscriptionCreate _$result;
    try {
      _$result = _$v ??
          new _$ActivitySubscriptionCreate._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ActivitySubscriptionCreate', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
