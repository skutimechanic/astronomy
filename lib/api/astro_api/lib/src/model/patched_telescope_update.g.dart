...
part of 'patched_telescope_update.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PatchedTelescopeUpdate extends PatchedTelescopeUpdate {
  @override
  final String? uuid;
  @override
  final String? name;
  ...
  factory _$PatchedTelescopeUpdate(
          [void Function(PatchedTelescopeUpdateBuilder)? updates]) =>
      (new PatchedTelescopeUpdateBuilder()..update(updates))._build();

  _$PatchedTelescopeUpdate._(
      {this.uuid,
      this.name,
      this.acronym,
      this.alias,
  ...
  @override
  PatchedTelescopeUpdate rebuild(
          void Function(PatchedTelescopeUpdateBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PatchedTelescopeUpdateBuilder toBuilder() =>
      new PatchedTelescopeUpdateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PatchedTelescopeUpdate &&
        uuid == other.uuid &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PatchedTelescopeUpdate')
          ..add('uuid', uuid)
          ..add('name', name)
          ..add('acronym', acronym)
          ..add('alias', alias)
...
class PatchedTelescopeUpdateBuilder
    implements Builder<PatchedTelescopeUpdate, PatchedTelescopeUpdateBuilder> {
  _$PatchedTelescopeUpdate? _$v;
  ...
  PatchedTelescopeUpdateBuilder() {
    PatchedTelescopeUpdate._defaults(this);
  }

  PatchedTelescopeUpdateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _uuid = $v.uuid;
      _name = $v.name;
  ...
  @override
  void replace(PatchedTelescopeUpdate other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PatchedTelescopeUpdate;
  }

  @override
  void update(void Function(PatchedTelescopeUpdateBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PatchedTelescopeUpdate build() => _build();

  _$PatchedTelescopeUpdate _build() {
    _$PatchedTelescopeUpdate _$result;
    try {
      _$result = _$v ??
          new _$PatchedTelescopeUpdate._(
              uuid: uuid,
              name: name,
              acronym: acronym,
              alias: alias,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PatchedTelescopeUpdate', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
