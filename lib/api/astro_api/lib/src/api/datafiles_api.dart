...
class DatafilesApi {
  ...
  const DatafilesApi(this._dio, this._serializers);
  ...
  Future<Response<DataFile>> datafilesCreate({ 
    required int pk,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> datafilesDestroy({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/datafiles/{id}/'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> datafilesDestroy2({ 
    ...
    final _path = r'/datafiles/{name}/'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesFormattedCreate({ 
    ...
    final _path = r'/datafiles{format}'.replaceAll('{' r'format' '}', format.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> datafilesFormattedDestroy({ 
    required String format,
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/datafiles/{id}{format}'.replaceAll('{' r'format' '}', format.toString()).replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> datafilesFormattedDestroy2({ 
    required String format,
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/datafiles/{name}{format}'.replaceAll('{' r'format' '}', format.toString()).replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<DataFile>>> datafilesFormattedList({ 
    required String format,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesFormattedPartialUpdate({ 
    required String format,
    required int id,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesFormattedPartialUpdate2({ 
    required String format,
    required String name,
    PatchedDataFile? patchedDataFile,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesFormattedRetrieve({ 
    required String format,
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesFormattedRetrieve2({ 
    required String format,
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesFormattedUpdate({ 
    required String format,
    required int id,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesFormattedUpdate2({ 
    required String format,
    required String name,
    required DataFile dataFile,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<DataFile>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<DataFile>>> datafilesList({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesPartialUpdate({ 
    required int id,
    PatchedDataFile? patchedDataFile,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesPartialUpdate2({ 
    required String name,
    PatchedDataFile? patchedDataFile,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesRetrieve({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesRetrieve2({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesUpdate({ 
    required int id,
    required DataFile dataFile,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [DataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataFile>> datafilesUpdate2({ 
    required String name,
    required DataFile dataFile,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<OrganisationDataFile>> organisationDatafilesCreate({ 
    ...
    final _path = r'/{organisation}/datafiles/'.replaceAll('{' r'organisation' '}', organisation.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [OrganisationDataFile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<OrganisationDataFile>> organisationDatafilesCreate2({ 
    required String format,
    required String organisation,
    required int pk,
    required bool isFits,
    ...
    final _path = r'/{organisation}/datafiles{format}'.replaceAll('{' r'format' '}', format.toString()).replaceAll('{' r'organisation' '}', organisation.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PaginatedOrganisationDataFileList>> organisationDatafilesRetrieve({ 
    required String organisation,
    int? page,
    int? pageSize,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [PaginatedOrganisationDataFileList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PaginatedOrganisationDataFileList>> organisationDatafilesRetrieve2({ 
    required String format,
    required String organisation,
    int? page,
    int? pageSize,
