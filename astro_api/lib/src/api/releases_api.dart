...
import 'package:openapi/src/model/release.dart';
...
class ReleasesApi {
  ...
  const ReleasesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Release>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Release>>> releasesFormattedList({ 
    ...
    final _path = r'/releases{format}'.replaceAll('{' r'format' '}', format.toString());
    ...
    BuiltList<Release> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(Release)]);
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Release>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Release>>> releasesList({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
