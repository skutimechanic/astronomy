...
part of 'target_tree_node_with_tree.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$TargetTreeNodeWithTree extends TargetTreeNodeWithTree {
  @override
  final int pk;
  @override
  final String? name;
  ...
  factory _$TargetTreeNodeWithTree(
          [void Function(TargetTreeNodeWithTreeBuilder)? updates]) =>
      (new TargetTreeNodeWithTreeBuilder()..update(updates))._build();

  _$TargetTreeNodeWithTree._(
      {required this.pk,
      this.name,
      this.color,
      this.notes,
      ...
      this.tree})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(pk, r'TargetTreeNodeWithTree', 'pk');
  }

  @override
  TargetTreeNodeWithTree rebuild(
          void Function(TargetTreeNodeWithTreeBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  TargetTreeNodeWithTreeBuilder toBuilder() =>
      new TargetTreeNodeWithTreeBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TargetTreeNodeWithTree &&
        pk == other.pk &&
        name == other.name &&
        color == other.color &&
        notes == other.notes &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'TargetTreeNodeWithTree')
          ..add('pk', pk)
          ..add('name', name)
          ..add('color', color)
          ..add('notes', notes)
...
class TargetTreeNodeWithTreeBuilder
    implements Builder<TargetTreeNodeWithTree, TargetTreeNodeWithTreeBuilder> {
  _$TargetTreeNodeWithTree? _$v;
  ...
  TargetTreeNodeWithTreeBuilder() {
    TargetTreeNodeWithTree._defaults(this);
  }

  TargetTreeNodeWithTreeBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _pk = $v.pk;
      _name = $v.name;
  ...
  @override
  void replace(TargetTreeNodeWithTree other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$TargetTreeNodeWithTree;
  }

  @override
  void update(void Function(TargetTreeNodeWithTreeBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  TargetTreeNodeWithTree build() => _build();

  _$TargetTreeNodeWithTree _build() {
    _$TargetTreeNodeWithTree _$result;
    try {
      _$result = _$v ??
          new _$TargetTreeNodeWithTree._(
              pk: BuiltValueNullFieldError.checkNotNull(
                  pk, r'TargetTreeNodeWithTree', 'pk'),
              name: name,
              color: color,
              notes: notes,
              isFolder: isFolder,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'TargetTreeNodeWithTree', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
