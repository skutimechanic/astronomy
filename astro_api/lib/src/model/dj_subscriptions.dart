...
abstract class DJSubscriptions implements Built<DJSubscriptions, DJSubscriptionsBuilder> {
    ...
    static void _defaults(DJSubscriptionsBuilder b) => b;

    factory DJSubscriptions([void updates(DJSubscriptionsBuilder b)]) = _$DJSubscriptions;

    @BuiltValueSerializer(custom: true)
    static Serializer<DJSubscriptions> get serializer => _$DJSubscriptionsSerializer();
}

class _$DJSubscriptionsSerializer implements StructuredSerializer<DJSubscriptions> {
    @override
    final Iterable<Type> types = const [DJSubscriptions, _$DJSubscriptions];

    @override
    final String wireName = r'DJSubscriptions';

    @override
    Iterable<Object?> serialize(Serializers serializers, DJSubscriptions object,
        ...
        result
            ...
            ..add(object.collectionMethod == null ? null : serializers.serialize(object.collectionMethod,
    ...
    @override
    DJSubscriptions deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = DJSubscriptionsBuilder();
