...
part of 'dj_subscription_plan.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DJSubscriptionPlan extends DJSubscriptionPlan {
  @override
  ...
  factory _$DJSubscriptionPlan(
          [void Function(DJSubscriptionPlanBuilder)? updates]) =>
      (new DJSubscriptionPlanBuilder()..update(updates))._build();

  _$DJSubscriptionPlan._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        djstripeId, r'DJSubscriptionPlan', 'djstripeId');
    BuiltValueNullFieldError.checkNotNull(
        djstripeCreated, r'DJSubscriptionPlan', 'djstripeCreated');
    BuiltValueNullFieldError.checkNotNull(
        djstripeUpdated, r'DJSubscriptionPlan', 'djstripeUpdated');
    BuiltValueNullFieldError.checkNotNull(id, r'DJSubscriptionPlan', 'id');
    BuiltValueNullFieldError.checkNotNull(
        active, r'DJSubscriptionPlan', 'active');
    BuiltValueNullFieldError.checkNotNull(
        currency, r'DJSubscriptionPlan', 'currency');
  }

  @override
  DJSubscriptionPlan rebuild(
          void Function(DJSubscriptionPlanBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DJSubscriptionPlanBuilder toBuilder() =>
      new DJSubscriptionPlanBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DJSubscriptionPlan &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DJSubscriptionPlan')
...
class DJSubscriptionPlanBuilder
    implements Builder<DJSubscriptionPlan, DJSubscriptionPlanBuilder> {
  _$DJSubscriptionPlan? _$v;
  ...
  DJSubscriptionPlanBuilder() {
    DJSubscriptionPlan._defaults(this);
  }

  DJSubscriptionPlanBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(DJSubscriptionPlan other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$DJSubscriptionPlan;
  }

  @override
  void update(void Function(DJSubscriptionPlanBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DJSubscriptionPlan build() => _build();

  _$DJSubscriptionPlan _build() {
    _$DJSubscriptionPlan _$result;
    try {
      _$result = _$v ??
          new _$DJSubscriptionPlan._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'DJSubscriptionPlan', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
