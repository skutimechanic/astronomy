...
part 'activity_subscription_create.g.dart';
...
/// * [organisation] 
/// * [collaboration] 
abstract class ActivitySubscriptionCreate implements Built<ActivitySubscriptionCreate, ActivitySubscriptionCreateBuilder> {
    ...
    ActivitySubscriptionCreate._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(ActivitySubscriptionCreateBuilder b) => b;

    factory ActivitySubscriptionCreate([void updates(ActivitySubscriptionCreateBuilder b)]) = _$ActivitySubscriptionCreate;

    @BuiltValueSerializer(custom: true)
    static Serializer<ActivitySubscriptionCreate> get serializer => _$ActivitySubscriptionCreateSerializer();
}

class _$ActivitySubscriptionCreateSerializer implements StructuredSerializer<ActivitySubscriptionCreate> {
    @override
    final Iterable<Type> types = const [ActivitySubscriptionCreate, _$ActivitySubscriptionCreate];

    @override
    final String wireName = r'ActivitySubscriptionCreate';

    @override
    Iterable<Object?> serialize(Serializers serializers, ActivitySubscriptionCreate object,
    ...
    @override
    ActivitySubscriptionCreate deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = ActivitySubscriptionCreateBuilder();
