...
/// * [findingCharts] 
abstract class PatchedTarget implements Built<PatchedTarget, PatchedTargetBuilder> {
    ...
    static void _defaults(PatchedTargetBuilder b) => b;

    factory PatchedTarget([void updates(PatchedTargetBuilder b)]) = _$PatchedTarget;

    @BuiltValueSerializer(custom: true)
    static Serializer<PatchedTarget> get serializer => _$PatchedTargetSerializer();
}

class _$PatchedTargetSerializer implements StructuredSerializer<PatchedTarget> {
    @override
    final Iterable<Type> types = const [PatchedTarget, _$PatchedTarget];

    @override
    final String wireName = r'PatchedTarget';

    @override
    Iterable<Object?> serialize(Serializers serializers, PatchedTarget object,
    ...
    @override
    PatchedTarget deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PatchedTargetBuilder();
