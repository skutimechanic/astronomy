...
part of 'patched_organisation_data_file.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PatchedOrganisationDataFile extends PatchedOrganisationDataFile {
  @override
  final int? pk;
  @override
  final String? name;
  ...
  factory _$PatchedOrganisationDataFile(
          [void Function(PatchedOrganisationDataFileBuilder)? updates]) =>
      (new PatchedOrganisationDataFileBuilder()..update(updates))._build();

  _$PatchedOrganisationDataFile._(
      {this.pk,
      this.name,
      this.isFits,
      this.isXisf,
  ...
  @override
  PatchedOrganisationDataFile rebuild(
          void Function(PatchedOrganisationDataFileBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PatchedOrganisationDataFileBuilder toBuilder() =>
      new PatchedOrganisationDataFileBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PatchedOrganisationDataFile &&
        pk == other.pk &&
        name == other.name &&
        isFits == other.isFits &&
        isXisf == other.isXisf &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PatchedOrganisationDataFile')
          ..add('pk', pk)
          ..add('name', name)
          ..add('isFits', isFits)
          ..add('isXisf', isXisf)
...
class PatchedOrganisationDataFileBuilder
    implements
        Builder<PatchedOrganisationDataFile,
            PatchedOrganisationDataFileBuilder> {
  _$PatchedOrganisationDataFile? _$v;
  ...
  PatchedOrganisationDataFileBuilder() {
    PatchedOrganisationDataFile._defaults(this);
  }

  PatchedOrganisationDataFileBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _pk = $v.pk;
      _name = $v.name;
  ...
  @override
  void replace(PatchedOrganisationDataFile other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PatchedOrganisationDataFile;
  }

  @override
  void update(void Function(PatchedOrganisationDataFileBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PatchedOrganisationDataFile build() => _build();

  _$PatchedOrganisationDataFile _build() {
    _$PatchedOrganisationDataFile _$result;
    try {
      _$result = _$v ??
          new _$PatchedOrganisationDataFile._(
              pk: pk,
              name: name,
              isFits: isFits,
              isXisf: isXisf,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PatchedOrganisationDataFile', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
