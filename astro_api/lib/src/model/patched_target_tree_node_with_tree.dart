...
import 'package:openapi/src/model/patched_target_tree_node_with_tree_target_class.dart';
import 'package:openapi/src/model/patched_target_equatorial_coordinates.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'patched_target_tree_node_with_tree.g.dart';
...
/// * [targetClass] 
/// * [tree] 
abstract class PatchedTargetTreeNodeWithTree implements Built<PatchedTargetTreeNodeWithTree, PatchedTargetTreeNodeWithTreeBuilder> {
    ...
    PatchedTargetTreeNodeWithTree._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(PatchedTargetTreeNodeWithTreeBuilder b) => b;

    factory PatchedTargetTreeNodeWithTree([void updates(PatchedTargetTreeNodeWithTreeBuilder b)]) = _$PatchedTargetTreeNodeWithTree;

    @BuiltValueSerializer(custom: true)
    static Serializer<PatchedTargetTreeNodeWithTree> get serializer => _$PatchedTargetTreeNodeWithTreeSerializer();
}

class _$PatchedTargetTreeNodeWithTreeSerializer implements StructuredSerializer<PatchedTargetTreeNodeWithTree> {
    @override
    final Iterable<Type> types = const [PatchedTargetTreeNodeWithTree, _$PatchedTargetTreeNodeWithTree];

    @override
    final String wireName = r'PatchedTargetTreeNodeWithTree';

    @override
    Iterable<Object?> serialize(Serializers serializers, PatchedTargetTreeNodeWithTree object,
    ...
    @override
    PatchedTargetTreeNodeWithTree deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PatchedTargetTreeNodeWithTreeBuilder();
