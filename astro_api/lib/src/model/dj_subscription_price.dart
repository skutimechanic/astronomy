...
import 'package:openapi/src/model/dj_subscription_price_type_enum.dart';
import 'package:openapi/src/model/dj_subscription_price_billing_scheme.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'dj_subscription_price.g.dart';
...
abstract class DJSubscriptionPrice implements Built<DJSubscriptionPrice, DJSubscriptionPriceBuilder> {
    ...
    DJSubscriptionPrice._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(DJSubscriptionPriceBuilder b) => b;

    factory DJSubscriptionPrice([void updates(DJSubscriptionPriceBuilder b)]) = _$DJSubscriptionPrice;

    @BuiltValueSerializer(custom: true)
    static Serializer<DJSubscriptionPrice> get serializer => _$DJSubscriptionPriceSerializer();
}

class _$DJSubscriptionPriceSerializer implements StructuredSerializer<DJSubscriptionPrice> {
    @override
    final Iterable<Type> types = const [DJSubscriptionPrice, _$DJSubscriptionPrice];

    @override
    final String wireName = r'DJSubscriptionPrice';

    @override
    Iterable<Object?> serialize(Serializers serializers, DJSubscriptionPrice object,
    ...
    @override
    DJSubscriptionPrice deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = DJSubscriptionPriceBuilder();
