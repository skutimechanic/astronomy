...
/// * [material] 
/// * [telescope] 
abstract class PatchedMirror implements Built<PatchedMirror, PatchedMirrorBuilder> {
    ...
    static void _defaults(PatchedMirrorBuilder b) => b;

    factory PatchedMirror([void updates(PatchedMirrorBuilder b)]) = _$PatchedMirror;

    @BuiltValueSerializer(custom: true)
    static Serializer<PatchedMirror> get serializer => _$PatchedMirrorSerializer();
}

class _$PatchedMirrorSerializer implements StructuredSerializer<PatchedMirror> {
    @override
    final Iterable<Type> types = const [PatchedMirror, _$PatchedMirror];

    @override
    final String wireName = r'PatchedMirror';

    @override
    Iterable<Object?> serialize(Serializers serializers, PatchedMirror object,
    ...
    @override
    PatchedMirror deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PatchedMirrorBuilder();
