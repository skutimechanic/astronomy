...
part 'activity_subscription_update.g.dart';
...
/// * [organisation] 
/// * [collaboration] 
abstract class ActivitySubscriptionUpdate implements Built<ActivitySubscriptionUpdate, ActivitySubscriptionUpdateBuilder> {
    ...
    ActivitySubscriptionUpdate._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(ActivitySubscriptionUpdateBuilder b) => b;

    factory ActivitySubscriptionUpdate([void updates(ActivitySubscriptionUpdateBuilder b)]) = _$ActivitySubscriptionUpdate;

    @BuiltValueSerializer(custom: true)
    static Serializer<ActivitySubscriptionUpdate> get serializer => _$ActivitySubscriptionUpdateSerializer();
}

class _$ActivitySubscriptionUpdateSerializer implements StructuredSerializer<ActivitySubscriptionUpdate> {
    @override
    final Iterable<Type> types = const [ActivitySubscriptionUpdate, _$ActivitySubscriptionUpdate];

    @override
    final String wireName = r'ActivitySubscriptionUpdate';

    @override
    Iterable<Object?> serialize(Serializers serializers, ActivitySubscriptionUpdate object,
    ...
    @override
    ActivitySubscriptionUpdate deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = ActivitySubscriptionUpdateBuilder();
