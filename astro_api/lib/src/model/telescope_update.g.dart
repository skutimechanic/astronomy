...
part of 'telescope_update.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$TelescopeUpdate extends TelescopeUpdate {
  @override
  final String uuid;
  @override
  final String? name;
  ...
  factory _$TelescopeUpdate([void Function(TelescopeUpdateBuilder)? updates]) =>
      (new TelescopeUpdateBuilder()..update(updates))._build();
  ...
  _$TelescopeUpdate._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(uuid, r'TelescopeUpdate', 'uuid');
    BuiltValueNullFieldError.checkNotNull(
        instruments, r'TelescopeUpdate', 'instruments');
    BuiltValueNullFieldError.checkNotNull(images, r'TelescopeUpdate', 'images');
  }

  @override
  TelescopeUpdate rebuild(void Function(TelescopeUpdateBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  TelescopeUpdateBuilder toBuilder() =>
      new TelescopeUpdateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TelescopeUpdate &&
        uuid == other.uuid &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'TelescopeUpdate')
          ..add('uuid', uuid)
          ..add('name', name)
          ..add('acronym', acronym)
          ..add('alias', alias)
...
class TelescopeUpdateBuilder
    implements Builder<TelescopeUpdate, TelescopeUpdateBuilder> {
  _$TelescopeUpdate? _$v;
  ...
  TelescopeUpdateBuilder() {
    TelescopeUpdate._defaults(this);
  }

  TelescopeUpdateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _uuid = $v.uuid;
      _name = $v.name;
  ...
  @override
  void replace(TelescopeUpdate other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$TelescopeUpdate;
  }

  @override
  void update(void Function(TelescopeUpdateBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  TelescopeUpdate build() => _build();

  _$TelescopeUpdate _build() {
    _$TelescopeUpdate _$result;
    try {
      _$result = _$v ??
          new _$TelescopeUpdate._(
              uuid: BuiltValueNullFieldError.checkNotNull(
                  uuid, r'TelescopeUpdate', 'uuid'),
              name: name,
              acronym: acronym,
              alias: alias,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'TelescopeUpdate', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
