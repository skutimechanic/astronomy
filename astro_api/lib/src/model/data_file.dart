...
/// * [tagArray] 
/// * [tags] 
abstract class DataFile implements Built<DataFile, DataFileBuilder> {
    ...
    static void _defaults(DataFileBuilder b) => b;

    factory DataFile([void updates(DataFileBuilder b)]) = _$DataFile;

    @BuiltValueSerializer(custom: true)
    static Serializer<DataFile> get serializer => _$DataFileSerializer();
}

class _$DataFileSerializer implements StructuredSerializer<DataFile> {
    @override
    final Iterable<Type> types = const [DataFile, _$DataFile];

    @override
    final String wireName = r'DataFile';

    @override
    Iterable<Object?> serialize(Serializers serializers, DataFile object,
    ...
    @override
    DataFile deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = DataFileBuilder();
