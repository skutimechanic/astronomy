...
part 'patched_organisation_data_file.g.dart';
...
/// * [tagArray] 
/// * [tags] 
abstract class PatchedOrganisationDataFile implements Built<PatchedOrganisationDataFile, PatchedOrganisationDataFileBuilder> {
    ...
    PatchedOrganisationDataFile._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(PatchedOrganisationDataFileBuilder b) => b;

    factory PatchedOrganisationDataFile([void updates(PatchedOrganisationDataFileBuilder b)]) = _$PatchedOrganisationDataFile;

    @BuiltValueSerializer(custom: true)
    static Serializer<PatchedOrganisationDataFile> get serializer => _$PatchedOrganisationDataFileSerializer();
}

class _$PatchedOrganisationDataFileSerializer implements StructuredSerializer<PatchedOrganisationDataFile> {
    @override
    final Iterable<Type> types = const [PatchedOrganisationDataFile, _$PatchedOrganisationDataFile];

    @override
    final String wireName = r'PatchedOrganisationDataFile';

    @override
    Iterable<Object?> serialize(Serializers serializers, PatchedOrganisationDataFile object,
    ...
    @override
    PatchedOrganisationDataFile deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PatchedOrganisationDataFileBuilder();
