...
import 'package:openapi/src/model/standard_star_catalogue_row.dart';
import 'package:built_collection/built_collection.dart';
import 'package:openapi/src/model/magnitude.dart';
import 'package:openapi/src/model/polarization.dart';
import 'package:openapi/src/model/magnitude_color.dart';
import 'package:openapi/src/model/astronomical_coordinates.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'standard_star.g.dart';
...
/// * [polarizations] 
/// * [catalogueRow] 
abstract class StandardStar implements Built<StandardStar, StandardStarBuilder> {
    ...
    static void _defaults(StandardStarBuilder b) => b;

    factory StandardStar([void updates(StandardStarBuilder b)]) = _$StandardStar;

    @BuiltValueSerializer(custom: true)
    static Serializer<StandardStar> get serializer => _$StandardStarSerializer();
}

class _$StandardStarSerializer implements StructuredSerializer<StandardStar> {
    @override
    final Iterable<Type> types = const [StandardStar, _$StandardStar];

    @override
    final String wireName = r'StandardStar';

    @override
    Iterable<Object?> serialize(Serializers serializers, StandardStar object,
    ...
    @override
    StandardStar deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = StandardStarBuilder();
