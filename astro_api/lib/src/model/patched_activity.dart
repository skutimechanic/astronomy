...
import 'package:openapi/src/model/programme.dart';
import 'package:openapi/src/model/activity_link.dart';
import 'package:openapi/src/model/astronomical_coordinates.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'patched_activity.g.dart';
...
/// * [organisation] 
/// * [collaboration] 
abstract class PatchedActivity implements Built<PatchedActivity, PatchedActivityBuilder> {
    ...
    static void _defaults(PatchedActivityBuilder b) => b
        ..title = ''
        ..content = ''
        ..label = '';

    factory PatchedActivity([void updates(PatchedActivityBuilder b)]) = _$PatchedActivity;

    @BuiltValueSerializer(custom: true)
    static Serializer<PatchedActivity> get serializer => _$PatchedActivitySerializer();
}

class _$PatchedActivitySerializer implements StructuredSerializer<PatchedActivity> {
    @override
    final Iterable<Type> types = const [PatchedActivity, _$PatchedActivity];

    @override
    final String wireName = r'PatchedActivity';

    @override
    Iterable<Object?> serialize(Serializers serializers, PatchedActivity object,
    ...
    @override
    PatchedActivity deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PatchedActivityBuilder();
