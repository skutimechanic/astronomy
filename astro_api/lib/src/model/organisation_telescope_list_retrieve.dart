...
import 'package:openapi/src/model/organisation_telescope_ownership.dart';
...
part 'organisation_telescope_list_retrieve.g.dart';
...
/// * [images] 
/// * [ownerships] 
abstract class OrganisationTelescopeListRetrieve implements Built<OrganisationTelescopeListRetrieve, OrganisationTelescopeListRetrieveBuilder> {
    ...
    BuiltList<OrganisationTelescopeOwnership> get ownerships;

    OrganisationTelescopeListRetrieve._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(OrganisationTelescopeListRetrieveBuilder b) => b;

    factory OrganisationTelescopeListRetrieve([void updates(OrganisationTelescopeListRetrieveBuilder b)]) = _$OrganisationTelescopeListRetrieve;

    @BuiltValueSerializer(custom: true)
    static Serializer<OrganisationTelescopeListRetrieve> get serializer => _$OrganisationTelescopeListRetrieveSerializer();
}

class _$OrganisationTelescopeListRetrieveSerializer implements StructuredSerializer<OrganisationTelescopeListRetrieve> {
    @override
    final Iterable<Type> types = const [OrganisationTelescopeListRetrieve, _$OrganisationTelescopeListRetrieve];

    @override
    final String wireName = r'OrganisationTelescopeListRetrieve';

    @override
    Iterable<Object?> serialize(Serializers serializers, OrganisationTelescopeListRetrieve object,
        ...
        result
            ...
            ..add(serializers.serialize(object.ownerships,
                specifiedType: const FullType(BuiltList, [FullType(OrganisationTelescopeOwnership)])));
        return result;
    }

    @override
    OrganisationTelescopeListRetrieve deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = OrganisationTelescopeListRetrieveBuilder();
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'ownerships':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(OrganisationTelescopeOwnership)])) as BuiltList<OrganisationTelescopeOwnership>;
