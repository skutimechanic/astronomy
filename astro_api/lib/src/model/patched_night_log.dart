...
/// * [calibrations] 
/// * [tagArray] 
abstract class PatchedNightLog implements Built<PatchedNightLog, PatchedNightLogBuilder> {
    ...
    static void _defaults(PatchedNightLogBuilder b) => b;

    factory PatchedNightLog([void updates(PatchedNightLogBuilder b)]) = _$PatchedNightLog;

    @BuiltValueSerializer(custom: true)
    static Serializer<PatchedNightLog> get serializer => _$PatchedNightLogSerializer();
}

class _$PatchedNightLogSerializer implements StructuredSerializer<PatchedNightLog> {
    @override
    final Iterable<Type> types = const [PatchedNightLog, _$PatchedNightLog];

    @override
    final String wireName = r'PatchedNightLog';

    @override
    Iterable<Object?> serialize(Serializers serializers, PatchedNightLog object,
    ...
    @override
    PatchedNightLog deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PatchedNightLogBuilder();
