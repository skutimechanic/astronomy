...
// tests for PatchedActivitySubscriptionUpdate
void main() {
  final instance = PatchedActivitySubscriptionUpdateBuilder();
  // TODO add properties to the builder and call build()

  group(PatchedActivitySubscriptionUpdate, () {
    // int pk
    ...
    // int emailsSent
    test('to test the property `emailsSent`', () async {
      // TODO
    });
    ...
    // String satellite
    test('to test the property `satellite`', () async {
      // TODO
    });
    ...
    // AstronomicalCoordinates coordinates
    ...
    // int collaboration
    test('to test the property `collaboration`', () async {
      // TODO
    });
